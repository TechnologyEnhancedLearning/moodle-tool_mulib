...
define([
    ...
    DialogForm.prototype.init = function() {
        ...
        M.util.js_pending('tool_mulib_dialog_form_init');
        Str.get_strings(requiredStrings)
            ...
            .then(function(modal) {
                ...
                // Forms may be big, let developer decide the modal size.
                if (this.config.size === 'xl') {
                    this.modal.getModal().addClass('modal-xl');
                } else if (this.config.size === 'lg') {
                    this.modal.getModal().addClass('modal-lg');
                }
                ...
                this.modal.getModal().addClass('tool_mulib-dialog_form');
                ...
                M.util.js_complete('tool_mulib_dialog_form_init');
                return this.modal;
            }.bind(this))
    ...
    DialogForm.prototype.getFormHtml = function(formData) {
        ...
        M.util.js_pending('tool_mulib_dialog_form_html');
        fetchFormHtml(this.config.formUrl, formData)
            .then(function(response) {
                if (response.dialog_form === 'render') {
                    ...
                    M.util.js_complete('tool_mulib_dialog_form_html');
                } else {
    ...
    DialogForm.prototype.submitFormAjax = function(e) {
        ...
        M.util.js_pending('tool_mulib_dialog_form_submit');
        fetchFormHtml(this.config.formUrl, formData)
            .then(function(response) {
                if (response.dialog_form === 'render') {
                    ...
                    M.util.js_complete('tool_mulib_dialog_form_submit');
    ...
    var fetchFormHtml = function(formUrl, formData) {
        ...
        var settings = {
            ...
            processData: false,
            async: true,
            headers: {'x-mulib-dialog-form-request': '1'},
            data: formData,
        };
